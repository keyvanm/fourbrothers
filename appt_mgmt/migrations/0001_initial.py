    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loyalty', models.PositiveSmallIntegerField(default=0, choices=[(0, b'$0'), (10, b'$10'), (20, b'$20'), (30, b'$30'), (40, b'$40'), (50, b'$50')])),
                ('appointment', models.OneToOneField(to='appt_mgmt.Appointment')),
                ('promo', models.ForeignKey(blank=True, to='user_manager.Promotion', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Service',
