...
from appt_mgmt.views import BuildingApptCreateView, HouseApptCreateView, ApptDetailView, ApptListView, ApptPayView, \
    ApptServiceCreateView, ApptEdit
...
urlpatterns = [
    ...
    url(r'^appointments/(?P<pk>\d+)/edit/$', ApptEdit.as_view(), name='appt-edit'),
