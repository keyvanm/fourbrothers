...
from appt_mgmt.views import BuildingApptCreateView, HouseApptCreateView, ApptDetailView

urlpatterns = [
    url(r'^$', login_required(TemplateView.as_view(template_name='appt_mgmt/appt-choose-type.html')), name='appt-choose-type'),
