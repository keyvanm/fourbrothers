    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=200, choices=[(b'Toronto', b'Downtown Toronto'), (b'Etobicoke', b'Etobicoke'), (b'Markham', b'Markham'), (b'North York', b'North York'), (b'Scarborough', b'Scarborough'), (b'Richmondhill', b'Richmondhill'), (b'Vaughan', b'Vaughan')])),
