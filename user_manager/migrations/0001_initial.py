    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=200, choices=[(b'Toronto', b'Downtown Toronto'), (b'East York', b'East York'), (b'Etobicoke', b'Etobicoke'), (b'Markham', b'Markham'), (b'North Toronto', b'North Toronto'), (b'North York', b'North York'), (b'Scarborough', b'Scarborough'), (b'Thornhill', b'Thornhill'), (b'Vaughan', b'Vaughan'), (b'York', b'York')])),
                ('state', models.CharField(default=b'Ontario', max_length=200, verbose_name=b'Province', choices=[(b'Ontario', b'Ontario')])),
